// Updated ShareView.jsx with better satellite image handling

import React, { useState, useEffect } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import { getSharedAllocation } from '../utils/firebase';
import ClubPitchMap from './satellite/ClubPitchMap';
...
function ShareView() {
  ...
  useEffect(() => {
    const loadSharedData = async () => {
      try {
        ...
        console.log('Satellite Image URL:', data?.satelliteImage);
        console.log('Map Image URL:', data?.mapImage);
        ...
        const updatedData = {
          ...
          // Ensure we use the correct image property
          satelliteImage: data?.satelliteImage || data?.mapImage || null
        };
        
        console.log('Updated data with satellite image:', updatedData.satelliteImage);
  ...
  const satelliteImage = sharedData?.satelliteImage || sharedData?.mapImage;
  const pitchPositions = sharedData?.pitchPositions || {};
  
  console.log('Final satellite image URL being used:', satelliteImage);
  console.log('Pitch positions being used:', pitchPositions);
  ...
  const handlePitchClick = (pitchId) => {
    console.log('Pitch clicked:', pitchId);
    ...
    <div style={{
      ...
      {!satelliteImage && (
        <div style={{
          ...
          <strong>Note:</strong> No satellite image found. Using default field view.
        </div>
      )}

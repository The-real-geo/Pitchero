    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div>
            ...
            {clubInfo && (
              <p style={{
                ...
                {clubInfo.name} â€¢ {user?.email} â€¢ Role: {userRole}
              </p>
            )}
          </div>
          <button
        ...
        {hasUnsavedChanges && !isSavingSettings && (
          ...
          role="status"
          >
            âš ï¸ You have unsaved changes. They will be saved automatically.
          </div>
        )}
        ...
        <div style={{
          ...
          <div style={{
            ...
            ðŸ’¡ Total teams configured: {teams.length}
          </div>
        </div>
        ...
        <div style={{
          ...
          {configuredPitches.length === 0 ? (
            ...
            <>
              ...
              <div style={{
                ...
                ðŸ’¡ {configuredPitches.length} pitch{configuredPitches.length !== 1 ? 'es' : ''} configured. 
          ...
          {!isAdmin && configuredPitches.length > 0 && (
            <div style={{
              ...
              âš ï¸ Note: Only administrators can change pitch names. Contact your admin if you need to update them.
            </div>
          )}
        </div>
      </div>
